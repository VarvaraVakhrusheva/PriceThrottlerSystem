...
/**
 * You have to write a com.price.processor.subject.PriceProcessor.PriceThrottler class which will implement the following requirements:
 ...
 *
 * In short words the purpose of com.price.processor.subject.PriceProcessor.PriceThrottler is to solve for slow consumers
 *
 */
public interface PriceProcessor {
     ...
     *
     * Изменила priceProcessor на priceObserver для полноценной реализации паттерна Наблюдатель
     * и работы класса не с самим собой, а со сторонними наблюдателями.
     *
     * @param priceObserver - can be up to 200 subscribers
     */
    void subscribe(Observer priceObserver);
     ...
     * @param priceObserver
     */
    void unsubscribe(Observer priceObserver);
